...
function Dashboard() {
    ...
    const fetchDataOrder = async () => {
      try {
        const responseOrder = await axios.get(
          "http://localhost:8090/admin/total-order"
        );
    ...
    const fetchBestSellers = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8090/admin/best-seller"
        );
  ...
  useEffect(() => {
    const fetchDataInventory = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8090/admin/inventory-list"
        );
  ...
  useEffect(() => {
    ...
    setColumns(getColumns(selectedType));
  }, [selectedType]);
  ...
  //     key: 'Image',
  //     render: (text, record) => (
  //       <img src={record.Image} alt="Product" style={{ width: '50px', height: '50px' }} />
  //     ),
  //   },
  //   { title: 'Product Type', dataIndex: 'ProductType', key: 'ProductType' },
  //   { title: 'Product Name', dataIndex: 'Name', key: 'Name' },
  ...
  useEffect(() => {
    const fetchDataOutStock = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8090/admin/out-stock-list"
        );
  ...
  useEffect(() => {
    const fetchDataNewUser = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8090/admin/new-customer"
        );
    ...
    <div className="dashboard">
        ...
        <section className="content-area-cards">
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>${revenue.DailyRevenue}</span>,
            }}
          />
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>${revenue.WeeklyRevenue}</span>,
            }}
          />
          ...
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>${revenue.MonthlyRevenue}</span>,
            }}
          />
        </section>
        <br />
        ...
        <section className="content-area-cards">
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{totalOrder.DailyOrders}</span>,
            }}
          />
          ...
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{totalOrder.WeeklyOrders}</span>,
            }}
          />
          ...
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{totalOrder.MonthlyOrders}</span>,
            }}
          />
        </section>
      ...
      <div className="inventory-management">
        ...
        >
          ...
          <Option value="DiamondRings">Diamond Rings</Option>
          <Option value="DiamondTimepieces">Diamond Timepieces</Option>
        </Select>
        <Table
          dataSource={inventoryData.filter(
            (item) => item.ProductType === selectedType
          )}
          columns={column}
        />
      </div>
        ...
        <section className="content-area-cards">
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{dataNewUser.NewCustomersToday}</span>,
            }}
          />
          ...
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{dataNewUser.NewCustomersThisWeek || "0"}</span>,
            }}
          />
          ...
          <AreaCard
            ...
            cardInfo={{
              ...
              value: <span>{dataNewUser.NewCustomersThisMonth || "0"}</span>,
            }}
          />
        </section>
