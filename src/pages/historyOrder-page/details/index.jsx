...
function HistoryOrderDetails() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row" }}>
      ...
      <div style={{ maxWidth: "800px", width: "100%", margin: "0px 0px 16px 0px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <Paper elevation={3} style={{ padding: "24px", borderRadius: "8px", width: "100%", maxWidth: "800px", display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">{order.OrderDetails[0].FirstName}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="subtitle1">Last Name:</Typography>
              <Typography variant="body1">{order.OrderDetails[0].LastName}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="subtitle1">Phone Number:</Typography>
              <Typography variant="body1">{order.OrderDetails[0].PhoneNumber}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12}>
              ...
              <Typography variant="body1">{order.OrderDetails[0].DeliveryAddress}</Typography>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              ...
              <Typography variant="body1">{order.OrderDetails[0].Shipping}</Typography>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              ...
              <Typography variant="body1">{order.OrderDetails[0].AttachedAccessories}</Typography>
            </Grid>
            ...
            {order.RequestWarranty !== null && (
              <Grid item xs={12} sm={6}>
                ...
                <Typography variant="body1" style={{color: "#616161", fontSize: "1.125rem" }}>
        ...
        <Button
          ...
          aria-label="back"
          onClick={handleBack}
          style={{ margin: "16px 0px 16px 0px", fontSize: "1.5rem", fontWeight: "bold" }}
        >
          <ArrowBackIcon />Back to history order
        </Button>
      </div>
