...
import { Button, Layout, Menu, theme, Table, Form, Input, InputNumber, Modal } from "antd";
...
function ManageDiamondPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'Image',
      render: (text, record) => (
        <img src={record.Image} alt="Diamond" style={{ width: '100px', height: 'auto' }} />
      ),
    },
  ...
  return (
    <Layout>
      ...
      <Header style={{ padding: 0, background: colorBgContainer }}>
        ...
        >
        <Button type="primary" onClick={() => setIsModalVisible(true)}>Add Diamond</Button>
      ...
      >
        ...
        >
          ...
          <Form.Item>
            <Button type="primary" htmlType="submit">Add Diamond</Button>
          </Form.Item>
        </Form>
      </Modal>
    </Layout>
